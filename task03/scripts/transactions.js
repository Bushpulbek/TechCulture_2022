...
const VToken_address = "0x8d1333bD5d28fF6c0706DB61043191d4bfFacde3";
const Stake_address = "0xd1125039DcDb644AebAbaa7f9592F590398d01A4";
const private_key = "baef34930ac74ddb24670fa6088756bbe77f85cad44e228ea3d1f4176f4ff0c0";
...
const token_contract = new ethers.Contract(VToken_address, VToken_ABI, provider);
const stake_contract = new ethers.Contract(Stake_address, Stake_ABI, provider);

async function main() {
    const address = "0xC3301B17D347fAa07d1A0e4C1dC274a1007f6780";
    const connect_token = token_contract.connect(wallet);
    ...
    // First, stake
    const deposit = 100000000000000000000n;
    const tx3 = await connect_stake.Stake(deposit);
    await tx3.wait();
    ...
    // Last, withdraw
    const tx5 = await connect_stake.Withdraw();
    await tx5.wait();
